      ...
      console.log(userBookings);
        ...
        useEffect(() => {
          const fetchPosts = async () => {
            try {
              const res = await fetch(`/api/user/custbookings/${currentUser._id}`)
          ...
          <table className="table-auto w-full border-collapse border border-gray-300">
            <thead>
              <tr className="bg-gray-200">
                ...
                <th className="border border-gray-300 px-4 py-2">My Number</th>
                <th className="border border-gray-300 px-4 py-2">Contact Number</th>
                <th className="border border-gray-300 px-4 py-2">My Address</th>
