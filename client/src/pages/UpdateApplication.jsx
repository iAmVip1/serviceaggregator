...
export default function UpdateApplication() {
    ...
    useEffect(() => {
        const fetchApplication = async () => {
            ...
            const res = await fetch(`/api/application/get/${applicationId}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setLoading(true);
            setError(false);
            const res = await fetch (`/api/application/update/${params.applicationId}`, {
                method: 'POST',
                headers: {
  ...
  return (
    <main className='p-3 max-w-4xl mx-auto min-h-screen'>
        ...
        <h1 className=' text-3xl font-semibold text-center my-7 '>Update your Documents and Details </h1>
